GO_BIN_FILES=streamscreen.go
GO_BIN_CMDS=github.com/lukaszgryglicki/streamscreen
...
BINARIES=streamscreen
STRIP=strip

all: check ${BINARIES}

streamscreen: streamscreen.go
	 ${GO_ENV} ${GO_BUILD} -o streamscreen streamscreen.go
